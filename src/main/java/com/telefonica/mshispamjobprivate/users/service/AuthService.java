...
import com.telefonica.mshispamjobprivate.event.payload.*;
import com.telefonica.mshispamjobprivate.exception.*;
import com.telefonica.mshispamjobprivate.security.JwtTokenProvider;
import com.telefonica.mshispamjobprivate.users.entity.*;
...
public class AuthService {
    ...
    public Optional<Authentication> authenticateUser(LoginRequest loginRequest) {
        log.info("AuthenticationMAIL ->,{}", loginRequest.getEmail());
